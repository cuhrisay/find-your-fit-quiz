...
const VALUE_MAPS = {
  ...
  // NOTE: the live form only has these 9 diagnosis options. Structure v4 also
  // mentions "Pelvic girdle pain", "Something else", and "I don't have a
  // diagnosis" (routing.js's DISQUALIFYING_DIAGNOSES/NON_CHRONIC_DIAGNOSIS_VALUES
  // still reference the first two) but none of those exist as real options here -
  // confirm with Chrisie/Trudy whether that's intentional before launch.
  diagnoses: {
