...
{
  "whyWeRecommend": "plain text, 2-4 sentences confirming the recommendation and tying it to what they told us",
  "forYouSpecifically": "plain text, 2-5 sentences covering routing notes/caveats in plain language, the free-text response handling below, and (if distressTier isn't 'none') one brief acknowledgment sentence",
...
1. If routing notes are present (car/height caveats, travel tradeoffs, "likely don't need the extra cost," etc.), explain them in plain language.
2. If the free text mentions a named condition, validate it without diagnosing: "that's not rare, we hear about [X] often" — never say "you have X" or contradict what they've already been told by a provider.
3. If the free text mentions buttock/hip/thigh pain but Screen 6 wasn't selected accordingly, or mentions a seat context (wheelchair, recliner, a specific car) that conflicts with their structured answers, gently flag the mismatch and suggest they double check or reach out.
4. If the free text describes symptoms suggesting they haven't seen a pelvic floor physical therapist yet, mention it's Trudy's first recommendation for almost everyone — not as a replacement for the cushion, alongside it.
5. If the free text is from someone describing prostatitis symptoms, you may gently note that a lot of men with this diagnosis actually have pelvic floor-related pain — without correcting or contradicting their diagnosis. Do not do this unprompted; only if they raise prostatitis themselves.
