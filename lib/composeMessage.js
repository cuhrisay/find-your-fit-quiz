...
const MORE_SUPPORT_BLOCK =
  ...
  '<p>Whatever you decide, we want you to feel supported. Check out our free ' +
  `<a href="${NAVIGATING_PELVIC_PAIN_GUIDE_URL}">Navigating Pelvic Pain guide</a>, ` +
  `browse the <a href="${BLOG_URL}">Pelvic Pain Answers blog</a>, or find a ` +
  `specialist through our <a href="${PROVIDER_DIRECTORY_URL}">Provider Directory</a>. ` +
  `Still not sure this is the right fit? Email us any time at ` +
