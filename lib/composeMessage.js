...
/**
 * All current second-cushion triggers are travel-motivated (see
 * routeSecondCushion in routing.js), so "for travel" is safe to hardcode here
 * rather than trying to squeeze trigger-specific wording into this budget too.
