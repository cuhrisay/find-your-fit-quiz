...
function routeProduct(answers) {
  ...
  // of central spots is fine), no diagnosis implying wider pain, and a duration
  ...
  return { product, sootherReason, sootherUpgradeLine };
}
...
const BREAK_IN_NOTE =
  'Keep in mind — our cushions come firm and soften over the first couple of ' +
  'weeks, and they take a little getting used to, since they hold you ' +
  'differently than an ordinary seat.';
